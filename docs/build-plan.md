...
- [ ] **PR-6** — Install docs + multi-agent usage examples + README rewrite (capabilities section landed via [#19](https://github.com/oveddan/lx-mcp/pull/19); license decided: MIT, 2026-07-08) —
